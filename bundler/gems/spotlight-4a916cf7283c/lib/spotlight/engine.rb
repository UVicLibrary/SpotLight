...
module Spotlight
  ...
  class Engine < ::Rails::Engine
    ...
    config.allowed_upload_extensions = %w(jpg jpeg png tif jp2)
    ...
    config.upload_fields = [
      ...
      OpenStruct.new(field_name: :spotlight_upload_date_tesim, label: 'Upload Date'),
	  OpenStruct.new(field_name: :spotlight_upload_custom_tesim, label: 'Custom test'),
	  OpenStruct.new(field_name: :spotlight_annotation_x_dbsm, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_y_dbsm, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_width_dbsm, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_height_dbsm, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_title_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_author_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_description_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_date_dtsim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_publisher_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: "spotlight_annotation_publisher-place_tesim", label: 'Hidden'),
	  OpenStruct.new(field_name: "spotlight_annotation_publisher-date_dtsim", label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_people_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_locations_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_transcript_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_genre_tesim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_annotation_public_isim, label: 'Hidden'),
	  OpenStruct.new(field_name: :spotlight_upload_consolesave_tesim, label: 'Console Save test')
    ]
